---
title: "Shopify Payments Checklist: Get Paid Faster in 2026"
slug: "shopify-payments-checklist"
pubDate: 2026-05-06
description: "Complete Shopify Payments setup checklist covering eligibility, document prep, activation steps, payout schedules & fraud prevention. Get paid on schedule in 2026."
author: "Vladislav T."
...
| Payout Method | Time to Access Funds | Notes |
|---|---|---|
| Standard ACH payout | 2 business days | Default for verified US accounts |
| New account hold | Up to 7 business days | Typically applies to first payouts only |
| Shopify Balance | Same day | Funds available as spendable balance |
...
Consider Shopify Balance if you need same-day access to funds. Money goes to your Shopify Balance account instead of waiting for ACH processing. The tradeoff: you're spending from a balance card rather than your primary business checking account. That can complicate accounting if you aren't tracking it separately. Read our full [Shopify Balance review](/shopify-balance-review) for details on FDIC insurance coverage and spending card features.
...
| Billing Descriptor | Customer Sees | Result |
|---|---|---|
| ❌ "ACME HOLDINGS LLC" | Confusing — customer doesn't recognize | Friendly fraud chargeback filed |
| ✅ "BRINE AND BOARD" | Matches the store where they bought | Customer recognizes the charge |
...
- [ ] **Check chargeback protection eligibility:** Shopify offers built-in chargeback protection on qualifying Shop Pay orders. See our [Shopify chargeback protection guide](/shopify-chargeback-protection) for full eligibility criteria.
...
For deeper analysis, our [Shopify fraud analysis guide](/shopify-fraud-analysis-guide) walks through reading risk indicators on the order detail page, including IP geolocation mismatches and multiple failed payment attempts.
...
- [ ] **Enable Shopify Markets** in **Settings > Markets** and configure your target countries. Full setup instructions are in our [Shopify Markets setup guide](/shopify-markets-setup).
...
- [ ] **Review international tax settings.** Selling cross-border triggers VAT (Value Added Tax), GST (Goods and Services Tax), or duty obligations depending on the destination. Check our [Shopify tax settings checklist](/shopify-tax-settings-checklist) for country-specific guidance.
...
- [ ] Review your current Shopify Payments credit card rates against competitor processors. Compare fees using our [Shopify Payments fees breakdown](/shopify-payments-fees) and [best payment gateways for Shopify](/best-payment-gateways-shopify).
